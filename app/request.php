...
class Request {
    ...
    private $socials = array('instagram');
    private $loadedSocials = array();
    ...
    public function start() {
        ...
        include_once (path('app/vendor/classes/api.php'));
    ...
    public function isSocial($module) {
        return in_array($module, $this->socials);
    }
    ...
    public  function load($route, $active = true, $filter = false, $permission = false) {
        ...
        if (preg_match('#::#', $controller)) {
            ...
            if($this->isSocial($theModule)) {
                $modulesPath = path('app/social/'.$theModule.'/controllers/');
            }
        }
        ...
        Hook::getInstance()->fire('controller.load.before');
        ...
        Hook::getInstance()->fire('controller.load.after');
